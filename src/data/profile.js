export const profile = {
  ...
  intro:
    '2022.09-2026.06 就读于上海海洋大学信息学院，计算机科学与技术本科，GPA 3.29/4。主修课程包括数据结构与算法、Java 框架编程、单片机原理与应用、微机原理与接口技术、计算机组成原理、操作系统原理、Linux 操作系统、信息安全概论、数据库原理、Python 程序设计、计算机网络、软件工程和编译原理。',
  highlights: [
